...
const OpenZoo2Page = () => {
  ...
  const predictOpenZoo = async () => {
    ...
    try {
      ...
      const url = `http://127.0.0.1:5004/adas`;
                ...
                >
                  <span
                    className={`button-text ${
                      modelName === "pedestrian-and-vehicle-detector-adas-0001"
                        ? "selected"
...
export default withNavigation(OpenZoo2Page);
