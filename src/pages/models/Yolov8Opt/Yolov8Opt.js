...
const YoloV8OptPage = () => {
  ...
  const predictYoloV8 = async () => {
    ...
    try {
      ...
      const url = `http://127.0.0.1:5002/seg-img`;
      ...
      userInputs = {
        userId: mongoId,
        type: "image",
        key: `${username}/results/yolov8-optimized/`,
        name: `${selectedElement.name}`,
        num_files: 0,
      };
  ...
  return (
    <>
      <div className="con-yolov8-opt">
        <h1>YOLO v8</h1>
        <h2>in ONNX format</h2>
...
export default withNavigation(YoloV8OptPage);
